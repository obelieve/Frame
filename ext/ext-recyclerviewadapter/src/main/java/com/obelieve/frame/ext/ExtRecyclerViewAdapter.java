package com.obelieve.frame.ext;


import static com.obelieve.frame.ext.ExtRecyclerViewAdapter.LoadMoreStatus.LOADING;
...
import com.obelieve.rvtools.R;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

public abstract class ExtRecyclerViewAdapter<DATA> extends RecyclerView.Adapter<ExtRecyclerViewAdapter.BaseViewHolder> {
    ...
    public static class BaseDataHolder<DATA> {
        ...
        private ExtRecyclerViewAdapter<DATA> mAdapter;

        public BaseDataHolder(ExtRecyclerViewAdapter adapter) {
            mAdapter = adapter;
        }
